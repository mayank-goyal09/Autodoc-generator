...
[![🚀 Live Demo](https://img.shields.io/badge/🚀_LIVE_DEMO-AutoDoc_Generator-4facfe?style=for-the-badge&labelColor=0c1445)](https://autodoc-generator-project.streamlit.app/)
[![GitHub Stars](https://img.shields.io/github/stars/mayank-goyal09/Autodoc-generator?style=for-the-badge&color=ffd700)](https://github.com/mayank-goyal09/Autodoc-generator/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/mayank-goyal09/Autodoc-generator?style=for-the-badge&color=87ceeb)](https://github.com/mayank-goyal09/Autodoc-generator/network)
...
```mermaid
graph TD
    A[🐍 Upload Python File] --> B[🧩 AST Abstract Parser]
    B --> C[✂️ Segment Functions]
    C --> D[🎛️ LLM Inference Core]
    D --> E[🧬 Format Guardrails]
    E --> F[🎯 Output File Rebuilding]
